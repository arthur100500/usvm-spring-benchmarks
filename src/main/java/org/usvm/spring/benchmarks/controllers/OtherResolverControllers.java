...
public class OtherResolverControllers {
    ...
    @RequestMapping(value = "/other/http_entity", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
    public HttpEntity<String> httpEntity(@RequestBody HttpEntity<Wallet> requestEntity) {
